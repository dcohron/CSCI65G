class BackgroundView:UIView {    
    var lightGradientColor = UIColor(red:0.8, green:0.0, blue:0.1, alpha:1.0)
    var darkGradientColor  = UIColor(red:0.0, green:0.0, blue:0.0, alpha:1.0)
    ...
    override func drawRect(rect: CGRect) {
        ...
        CGContextDrawLinearGradient(context,
            ...
            CGGradientDrawingOptions(rawValue:3));
    }
}
